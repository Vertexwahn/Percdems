...
Invoke-WebRequest https://dl.bintray.com/boostorg/release/1.65.1/source/boost_1_65_1.zip -OutFile C:\thirdparty\vs2017\x64\boost_1_65_1.zip
	
# Check file hash
$value = Get-FileHash C:\thirdparty\vs2017\x64\boost_1_65_1.zip -Algorithm SHA256
	
if($value.Hash -ne "d1775aef807bd6a14077b450cce2950d8eacd86aaf51015f79e712917f8cc3c2") {
...
If (Test-Path $strFileName){
	...
	sz x C:\thirdparty\vs2017\x64\boost_1_65_1.zip -oC:\thirdparty\vs2017\x64
} Else {
...
Remove-Item C:\thirdparty\vs2017\x64\boost_1_65_1.zip
...
# Build
cd C:\thirdparty\vs2017\x64\boost_1_65_1
