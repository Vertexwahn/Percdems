...
Invoke-WebRequest https://dl.bintray.com/boostorg/release/1.66.0/source/boost_1_66_0.zip -OutFile C:\thirdparty\vs2017\x64\boost_1_66_0.zip
	
# Check file hash
$value = Get-FileHash C:\thirdparty\vs2017\x64\boost_1_66_0.zip -Algorithm SHA256
...
If (Test-Path $strFileName){
	...
	sz x C:\thirdparty\vs2017\x64\boost_1_66_0.zip -oC:\thirdparty\vs2017\x64
} Else {
...
Remove-Item C:\thirdparty\vs2017\x64\boost_1_66_0.zip
...
# Build
cd C:\thirdparty\vs2017\x64\boost_1_66_0
